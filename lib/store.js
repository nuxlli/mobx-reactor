      ...
      if (prototype.hasOwnProperty('__actions__')) {
        Object.keys(prototype.__actions__).forEach(function (type) {
          var actions = prototype.__actions__[type].map(function (_ref) {
            ...
            var other = _objectWithoutProperties(_ref, ['methodName']);
              ...
              promises.push(new Promise(function (resolve, reject) {
                var processStep = function processStep(_ref3) {
                  ...
                  var proccessEffect = function proccessEffect(result) {
                    var method = arguments.length <= 1 || arguments[1] === undefined ? 'next' : arguments[1];
                  ...
                  if (effect) {
                    switch (effect.type) {
                      ...
                      case 'call':
                        ...
                        var _func = _effect$payload.func;
                        var args = _effect$payload.args;
                ...
                if ("then" in stepper) {
                  stepper.then(function (value) {
                    return processStep({ value: value, done: true });
                  });
                } else {
...
function isGeneratorIterable(value) {
  return value !== null && value !== undefined && ('next' in value && 'throw' in value || 'then' in value && 'catch' in value);
}